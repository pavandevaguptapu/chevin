...
class AccountDetails extends React.Component {  
    constructor(props) {
        ...
        this.state = {
            ...
            processArray: [
                ...
                {"name":"Quality Management","processID":5,"tools":[{"name":"jira"},{"name":"SonarQube"}]}, 
    ...
    jumpstartConfiguration=()=>{
        var selectedTool=this.state.editableProcessArray[this.state.stepIndex].tools[0].name
        this.setState({jumpstartModal:true,selectedTool:selectedTool})
    }
    closejumpstartConfiguration=()=>{
        this.setState({jumpstartModal:false})
    }
    handleNext = () => {
        console.log(this.state.stepIndex,"first")

        var i = 0 + this.state.stepIndex

        // if (i === 0) {
        //     this.setState({ stepIndex: 1 })
        // }
        // else if (i !== 0) {
        //     this.setState({ stepIndex: i + 1 })
        // }
        var processArray = this.state.processArray
        if (this.state.stepIndex < processArray.length-1) {
            this.setState({stepIndex: this.state.stepIndex + 1});
        }
        if (this.state.stepIndex +1=== this.state.processArray.length - 1) {
            this.setState({ lastItem: true })
        }
        console.log(this.state.stepIndex,"last")
    ...
    render() {  
        console.log(this.state.stepIndex,"render") 
          return (
                        ...
                        <div className="loginBtns">
                            <div>
                                ...
                                <RaisedButton 
                                    ...
                                    primary={true} 
                                    style={modelbuttonsStyle} 
                                    onClick={() => this.addProject(this.state.newProjectDetails)} 
                ...
                <Dialog open={this.state.addPeopleModal} contentStyle={{"left":"70%"}} className={["col-md-6 col-lg-5 "].join(' ')}>
                    ...
                    <div className="row margin0">
                        ...
                        <div className="row margin0">
                            ...
                            <div className="col-md-12 custId">
                                <TextField 
                                  ...
                                  //  value={this.state.newPeopleObj._id||''}
                                    name='memeber id' 
                                    onChange={this.handleAddTeamDetails}                                                                
                                    fullWidth={true}
                                />
                        ...
                        <div className="row margin0">
                            ...
                            <div className="col-md-12">
                                <TextField 
                                   // value={this.state.newPeopleObj.customerName || ''} 
                                    name='memeber name' 
                                    onChange={this.handleAddTeamDetails}      
                        ...
                        <div className="row margin0">
                            ...
                            hintText="username"
                            //value={this.state.newPeopleObj.status || ''}
                            name='username'
                            onChange={this.handleAddTeamDetails} 
                        />
                            </div>
                        ...
                        <div className="row margin0">
                            ...
                            <div className="col-md-12">
                                <TextField 
                                    ...
                                    hintText="password"
                               //     value={this.state.newPeopleObj.engagementModel || ''}
                                    name='password'
                                    onChange={this.handleAddTeamDetails} 
                                />
                            </div>
                        ...
                        <div className="row margin0">
                            ...
                            <TextField 
                                    ...
                                    hintText="role"
                                //    value={this.state.newPeopleObj.startDate || ''}
                                    name='role'
                                    onChange={this.handleAddTeamDetails} 
                                />
                            {/* <DatePicker
                        ...
                        <div className="row margin0">
                            ...
                            <TextField 
                                    ...
                                    hintText="account id"
                               //     value={this.state.newPeopleObj.endDate || ''}
                                    name='account id'
                                    onChange={this.handleAddTeamDetails} 
                                />
                            {/* <DatePicker
                              ...
                              <div className={["col-lg-12 col-md-12 displayInline pt-2 pr-0 pl-0"]}>
                                  <div className="col-md-6 col-lg-6 pl-0">
                                      <div className={["col-md-12 custId"]}>
                                          ...
                                          <SelectField hintText="Select Project" value={this.state.selectedTool}
