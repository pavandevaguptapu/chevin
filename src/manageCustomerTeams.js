...
class ManageCustomerTeams extends React.Component {
  ...
  handleAccountName(accountName) {
    ...
    tempAccountsArray[this.state.selectedAccountIndex].customerName =
  ...
  currentAccountProfile(currentAccountDetails, index) {
    ...
    axios
      .get(myConstClass.nodeAppUrl + "/accounts/" + currentAccountDetails._id)
      .then(response => {
        this.setState({
  ...
  addNewAccount(newCustomerDetailsObject) {
    axios
      .post(myConstClass.nodeAppUrl + `/accounts`, {
      ...
      .then(response => {
        this.state.accountsArray = this.state.accountsArray.concat(
          response.data
        );
  ...
  selectedDashboardItem(item) {
    if (this.state.currentSelectedDashboardItem !== undefined) {
      document
        .getElementById(this.state.currentSelectedDashboardItem)
        .classList.remove("selectedDashboardItem");
    }
    this.state.currentSelectedDashboardItem = item.target.parentNode.id;
    document
      .getElementById(item.target.parentNode.id)
      .classList.add("selectedDashboardItem");
  }
  ...
  render() {
    return (
      <div className="container-fluid padding0">
        <nav className="navbar navbar-fixed-top navbarBgColor navbarFontColor padding0">
          <div className="col-md-12 flex">
            <div className="col-md-3 col-lg-2 marginT16">
              ...
              <h4
                className="margin0 pointer paddingL04"
                onClick={e => this.openSideMenu()}
              >
        ...
        <Dialog
          open={this.state.createAccountModal}
          className={["col-md-6 col-lg-5 modalMargins modalBgColor 1 "].join(
            " "
          )}
        >
          <div className="row">
                ...
                <div>
                  ...
                  <div className="d-inline">
                    <RaisedButton
                      ...
                      style={modelbuttonsStyle}
                      onClick={() =>
                        this.addNewAccount(this.state.newCustomerDetails)
                      }
...
class AccountDetails extends React.Component {
      ...
      .post(
        ...
        },
        {
          headers: {
            ...
            Authorization:
              "Basic cGF2YW5rdW1hci5kQGNvbWFrZWl0LmNvbTpBYmNAMTIzNA=="
          }
        }
      )
      .then(response => {
  ...
  addNewProject(newProjectObject) {
    ...
    axios
      .put(
        myConstClass.nodeAppUrl + `/accounts/` + this.state.currentAccount._id,
        {
  ...
  configJumpStart(projectIndex) {
    if (this.state.currentAccount.projects[projectIndex].tools === undefined) {
      this.setState({
        jumpStartConfigModel: true,
        selectedProjectIndex: projectIndex,
        selectTool: (
          <ToolConfigurationDetails
            selectedAccount={this.state.currentAccount}
            selectedProjectIndex={projectIndex}
    ...
    if (this.state.currentAccount.projects[projectIndex].tools !== undefined) {
      ...
      for (var JumpStartMenuName in this.state.currentAccount.projects[
        projectIndex
      ].tools) {
  ...
  handlingPeopleList(latestPeopleDate) {
    ...
    for (
      var i = 0;
      i <
      latestPeopleDate.projects[this.state.selectedProjectIndex].people.length;
      i++
    ) {
      tempPeoplesArray.push(
        latestPeopleDate.projects[this.state.selectedProjectIndex].people[i]
      );
    }
  ...
  updatePeopleList(updatedPeopleData) {
    ...
    for (
      var i = 0;
      i <
      updatedPeopleData.projects[this.state.selectedProjectIndex].people.length;
      i++
    ) {
      tempPeoplesArray.push(
        updatedPeopleData.projects[this.state.selectedProjectIndex].people[i]
      );
    }
    this.setState({ peoplesArray: tempPeoplesArray });
  }
  ...
  deletePeopleList(deletedPeopleList) {
    ...
    for (
      var i = 0;
      i <
      deletedPeopleList.projects[this.state.selectedProjectIndex].people.length;
      i++
    ) {
      tempPeoplesArray.push(
        deletedPeopleList.projects[this.state.selectedProjectIndex].people[i]
      );
    }
    this.setState({ peoplesArray: tempPeoplesArray });
  }
  ...
  curentSelectedIteminPeople(selectedNameObj, index) {
    this.setState({
      people: (
        <PeopleConfigurationDetails
          selectedMemberObj={selectedNameObj}
  ...
  componentWillMount() {
    ...
    var latestTeam =
      currentAccountArray[currentAccountArray.length - 1].customerName;
    ...
    for (
      var i = 0;
      i < currentAccountArray[lastitemIndex].projects.length;
      i++
    ) {
      ...
      if (currentAccountArray[lastitemIndex].projects[i].people == undefined) {
        ...
        eachProjectMembers =
          currentAccountArray[lastitemIndex].projects[i].people.length;
    ...
    if (currentAccountArray[lastitemIndex].projects.length !== 0) {
      ...
      if (
        currentAccountArray[currentAccountArray.length - 1].projects[0]
          .people === undefined
      ) {
        ...
        var peopleArrayOfselectedProject =
          currentAccountArray[currentAccountArray.length - 1].projects[0]
            .people;
        this.setState({
          peopleArray: peopleArrayOfselectedProject,
          noPeople: false
        });
      }
      ...
      if (
        ...
        var jumpstartListofTools = Object.keys(
          currentAccountArray[currentAccountArray.length - 1].projects[0].tools
        );
  ...
  selectTeam = (event, selectedTeamIndex, value) => {
    ...
    for (
      var i = 0;
      i < currentAccount[selectedTeamIndex].projects.length;
      i++
    ) {
      x = eachProjectMembers;
      if (currentAccount[selectedTeamIndex].projects[i].people == undefined) {
        ...
        eachProjectMembers =
          currentAccount[selectedTeamIndex].projects[i].people.length;
        allMembersinProject = x + eachProjectMembers;
        this.setState({ totalMembers: allMembersinProject });
      }
    }
    ...
    if (currentAccount[selectedTeamIndex].projects.length !== 0) {
      ...
      if (currentAccount[selectedTeamIndex].projects[0].people === undefined) {
        ...
        var peopleArrayOfselectedProject =
          currentAccount[selectedTeamIndex].projects[0].people;
        this.setState({
          peopleArray: peopleArrayOfselectedProject,
          noPeople: false
        });
      ...
      if (currentAccount[selectedTeamIndex].projects[0].tools === undefined) {
        ...
        var jumpstartListofTools = Object.keys(
          currentAccount[selectedTeamIndex].projects[0].tools
        );
  ...
  editTeam = () => {
    ...
    this.setState({
      editTeamModal: true,
      TeamDetailsArrayForEditing: tempArray
    });
  };
  handleTeamDetails = e => {
    // if(e!==null){
  ...
  updateTeam(modifiedTeamObj) {
    axios
      .put(myConstClass.nodeAppUrl + `/accounts/` + modifiedTeamObj._id, {
      ...
      .then(response => {
        ...
        var updatedTeamName =
          updatedObj[this.state.selectedTeamIndex].customerName;
        console.log(updatedObj);
        this.setState({
          currentAccount: updatedObj,
  ...
  selectedProject = selectedProjectIndex => {
    ...
    var currentAccount = this.state.currentAccount;
    if (
      currentAccount[this.state.selectedTeamIndex].projects[
        selectedProjectIndex
      ].people === undefined
    ) {
      this.setState({ noPeople: true });
  ...
  addNewProject(newProjectObject) {
    ...
    tempAccountsArray[this.state.selectedTeamIndex].projects.push(
      newProjectObject
    );

    axios
      .put(
        myConstClass.nodeAppUrl +
          `/accounts/` +
          tempAccountsArray[this.state.selectedTeamIndex]._id,
        {
          customerName:
            tempAccountsArray[this.state.selectedTeamIndex].customerName,
          startDate: "13/12/2017",
          endDate: "13/12/2017",
          engagementModel:
            tempAccountsArray[this.state.selectedTeamIndex].engagementModel,
          pricingModel:
            tempAccountsArray[this.state.selectedTeamIndex].pricingModel,
          seniorSupplier: "asewr",
          projectManager: "jg",
      ...
      .then(response => {
        ...
        if (
          currentAccount[this.state.selectedTeamIndex].projects.length === 0
        ) {
          this.setState({ noProject: true, noPeople: true, noTool: true });
        } else {
          var ProjectsArray =
        ...
        for (
          var i = 0;
          i < currentAccount[this.state.selectedTeamIndex].projects.length;
          i++
        ) {
          x = eachProjectMembers;
          if (
            currentAccount[this.state.selectedTeamIndex].projects[i].people ==
            undefined
          ) {
            noMember = 0;
            allMembersinProject = noMember + x;
        ...
        if (
          ...
          // if projects array not equal to undefined and people array is udefined
          if (
            currentAccount[this.state.selectedTeamIndex].projects[0].people ===
            undefined
          ) {
            this.setState({ noPeople: true });
          } else {
          ...
          if (
            currentAccount[this.state.selectedTeamIndex].projects[0].tools ===
            undefined
          ) {
            // var jumpstartListofTools = ["no tools are configured to this project"]
            this.setState({ isTooldata: false, noTool: true });
        ...
        this.setState({
          currentAccount: currentAccount,
          selectedTeamName:
            currentAccount[this.state.selectedTeamIndex].customerName,
  ...
  render() {
    return (
      <div className="col-lg-12 col-md-12 mt-1">
            ...
            <div className="displayInline col-lg-12 col-md-12 p-1">
              <div className="col-md-2 col-lg-2 p-0">
                <div className="d-flex col-md-12 col-lg-12 pl-0 pb-2 pt-1">
                  <div
                    className={"project_details pt-0 pl-2 pr-0 d-inline-flex"}
                  >
                  ...
                  <div>
                    <SelectField
                      ...
                      labelStyle={{ height: "37px" }}
                      style={{ width: "100%" }}
                      underlineStyle={{ display: "none" }}
                      onChange={(e, i, v) => this.selectTeam(e, i, v)}
                    >
              ...
              <div className="col-md-9 col-lg-9">
                <p style={{ color: "rgba(0, 0, 0, 0.54)", font: "12px" }}>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. In
                  lobortis hendrerit metus, id laoreet nulla iaculis sit amet.
                  Duis ac purus sit amet arcu mattis hendrerit.
                </p>
                  ...
                  <div className="col-md-12 col-lg-12 displayInline p-0">
                    <div className="col-md-2 col-lg-2 p-0 m-2 displayInline">
                      <div className="textAlignCenter pr-2">
                        ...
                        <Subheader
                          className="p-1"
                          style={{ fontSize: "14px", lineHeight: "4px" }}
                        >
                          Projects
                        </Subheader>
                      </div>
                      <div
                        className="font"
                        style={{ lineHeight: "38px", fontWeight: "lighter" }}
                      >
                        {
                    ...
                    <div className="col-md-2 col-lg-3 displayInline m-2 p-0">
                      <div className="textAlignCenter pr-2">
                        ...
                        <Subheader
                          className="p-1"
                          style={{ fontSize: "12px", lineHeight: "4px" }}
                        >
                          Start Date
                        </Subheader>
                      </div>
            ...
            <Tabs inkBarStyle={{ background: "#FF3D00" }}>
              ...
              <Tab label="Projects" style={tabsBackgroundColor}>
                <div style={{ border: "1px solid rgb(238, 238, 238)" }}>
                  <Table onCellClick={this.selectedProject}>
                    ...
                    <TableBody
                      ...
                      className={[
                        this.state.noProject === false ? "show" : "visibility"
                      ].join(" ")}
                    >
                      {this.state.currentAccount[
                        this.state.selectedTeamIndex
                ...
                <div
                  ...
                  className={[
                    this.state.noProject === true ? "show" : "visibility"
                  ].join(" ")}
                >
                  <Subheader
                    className="p-0 textAlignCenter"
                    style={{ fontSize: "20px" }}
                  >
              ...
              <Tab label="People" style={tabsBackgroundColor}>
                <div
                  style={{ border: "1px solid rgb(238, 238, 238)" }}
                  className={[
                    this.state.noPeople === false ? "show" : "visibility"
                  ].join(" ")}
                >
                  {" "}
                  <Table>
                ...
                <div
                  style={{ border: "1px solid rgb(238, 238, 238)" }}
                  className={[
                    this.state.noPeople === true ? "show" : "visibility"
                  ].join(" ")}
                >
                  <Subheader
                    className="p-0 textAlignCenter"
              ...
              <Tab
                label="Jump Start"
                style={tabsBackgroundColor}
                disabled={this.state.noProject === true}
              >
                <div
                  style={{ border: "1px solid rgb(238, 238, 238)" }}
                  className={[
                    "col-lg-12 d-flex",
                    this.state.noTool === false ? "show" : "visibility"
                  ].join(" ")}
                >
                  <div
                    className={[
                      "col-lg-3 col-md-3 py-2",
                      this.state.noTool === false ? "show" : "visibility"
                    ].join(" ")}
                  >
                    <SelectableList style={{ border: "1px solid #eee" }}>
                      {this.state.listofToolsarray.map((item, index) => (
                        <ListItem
                          ...
                          className={[
                            index === this.state.selectedToolIndex
                              ? "selectedItem"
                              : ""
                          ].join(" ")}
                        />
                  ...
                  <div
                    className={[
                      "col-lg-9 col-md-9 displayInline p-4",
                      this.state.noTool === false ? "show" : "visibility"
                    ].join(" ")}
                  >
                    <div className="col-md-6 col-lg-6">
                      <div
                        className={[
                          "col-md-12 custId",
                          this.state.isTooldata === true ? "show" : "visibility"
                        ].join(" ")}
                      >
                        <Subheader
                          className="p-0"
                ...
                <div
                  style={{ border: "1px solid rgb(238, 238, 238)" }}
                  className={[
                    this.state.noTool === true ? "show" : "visibility"
                  ].join(" ")}
                >
                  <Subheader
                    className="p-0 textAlignCenter"
        ...
        <Dialog
          open={this.state.editTeamModal}
          contentStyle={{ left: "70%" }}
          className={["col-md-6 col-lg-5 "].join(" ")}
        >
          <div className="row">
            <div className="col-md-12 col-lg-12 textAlignCenter">
              <Subheader className="p-0" style={{ fontSize: "30px" }}>
                Team Details
              </Subheader>
            </div>
          </div>
            ...
            <div className="row margin0">
              ...
              <div className="col-md-12 custId">
                <TextField
                  ...
                  value={
                    this.state.TeamDetailsArrayForEditing[
                      this.state.selectedTeamIndex
                    ]._id
                  }
                  name="_id"
        ...
        <Dialog
          open={this.state.createProjectModel}
          contentStyle={{ left: "70%" }}
          className={["col-md-6 col-lg-5"].join(" ")}
        >
          <div className="row">
            ...
            <div className="loginBtns">
              <div>
                ...
                <RaisedButton
                  ...
                  style={modelbuttonsStyle}
                  onClick={() =>
                    this.addNewProject(this.state.newProjectDetails)
                  }
        ...
        <Dialog
          open={this.state.jumpStartConfigModel}
          contentStyle={{ left: "70%" }}
          className={["col-md-6"].join(" ")}
        >
          <div className="row">
            <div className="col-md-12 col-lg-12">
              <h5 className="marginT0 font fontSize17">
                ...
                <FloatingActionButton
                  ...
                  onClick={() => this.closeJumpStartModel()}
                >
                  <ContentClear />
                </FloatingActionButton>
              </h5>
              ...
              <div className="textAlignLeft col-md-3 col-lg-4  mctJumpstartmodalmargins boxshadowfordata borderRadius vh">
                {this.state.configureTools.map((item, index) => (
                  <div
                    className={[
                      "pointer",
                      this.state.configureTools[index]
                        .selectedJumpStartMenuItem == true
        ...
        <Dialog
          open={this.state.configPeopleModel}
          contentStyle={{ left: "70%" }}
          className={["col-md-6"].join(" ")}
        >
          <div className="row">
                ...
                <div className="textAlignLeft col-md-3 col-lg-4  mctJumpstartmodalmargins boxshadowfordata borderRadius vh">
                  {this.state.peoplesArray.map((people, index) => (
                    <div
                      ...
                      key={people.emailid}
                      onClick={() =>
                        this.curentSelectedIteminPeople(people, index)
                      }
                    >
                      {people.name}
                    </div>
        ...
        <Dialog
          open={this.state.createGithubProjectModel}
          contentStyle={{ left: "70%" }}
          className={["col-md-6 col-lg-5"].join(" ")}
        >
          <div className="row">
          ...
          <div className="textAlignLeft">
            <div className="row margin0">
              <div className="col-md-5 margin10">
                <label>Repositpry Name:</label>
              </div>
              <div className="col-md-6 custId">
                <input
                  value={this.state.githubInstance.repoName}
                  name="repoName"
                  onChange={this.handleGithubInstance}
                />
              </div>
              <div className="col-md-5 margin10">
              ...
              <div className="col-md-6 custId">
                <input
                  value={this.state.githubInstance.projectName}
                  name="projectName"
                  onChange={this.handleGithubInstance}
                />
              </div>
              <div className="col-md-5 margin10">
                <label>Project Url(import):</label>
              </div>
              <div className="col-md-6 custId">
                <input
                  value={this.state.githubInstance.projectUrl}
                  name="projectUrl"
                  onChange={this.handleGithubInstance}
                />
              </div>
            ...
            <div className="loginBtns">
              <div>
                <RaisedButton
                  ...
                  secondary={true}
                  style={modelbuttonsStyle}
                  onClick={() => this.closeGithubDetails()}
                />
                <RaisedButton
                  label="Done"
                  primary={true}
                  style={modelbuttonsStyle}
                  onClick={() =>
                    this.submitGithubDetails(this.state.githubInstance)
                  }
                />
              </div>
            </div>
...
class ToolConfigurationDetails extends React.Component {
  constructor(props) {
    ...
    this.state = {
      wikiList: [{ id: 1, name: "Confluence" }, { id: 2, name: "Slack" }],
      userConfigDetails: "",
      currentAccount: obj,
      selectedProjectIndex: "",
      selectedItemName: "",
  ...
  componentWillMount() {
    ...
    if (
      dupeAccountArray.projects[this.props.selectedProjectIndex].tools[
        this.props.selectedJumpStartMenuName
      ] == undefined
    ) {
      dupeAccountArray.projects[this.props.selectedProjectIndex].tools[
        this.props.selectedJumpStartMenuName
      ] = { name: "", userName: "", password: "", hostedURL: "" };

      this.setState({
        dupeCurrentAccountArray: dupeAccountArray,
    ...
    if (this.props.selectedJumpStartMenuName == "Issue Management") {
      this.setState({
        wikiList: [{ id: 1, name: "Jira" }, { id: 2, name: "Github" }],
        dupeCurrentAccountArray: dupeAccountArray,
        selectedProjectIndex: this.props.selectedProjectIndex,
        selectedItemName: this.props.selectedJumpStartMenuName
      });
  ...
  handleChangeInJumpStart(e, index, value) {
    ...
    if (
      tempArray.projects[this.props.selectedProjectIndex].tools === undefined
    ) {
    ...
    if (
      this.state.currentAccount.projects[this.state.selectedProjectIndex].tools[
        this.state.selectedItemName
      ].name !== value
    ) {
      tempArray.projects[this.state.selectedProjectIndex].tools[
        this.state.selectedItemName
      ] = { name: value, userName: "", password: "", hostedURL: "" };
    }
    ...
    if (
      ...
      tempArray.projects[this.state.selectedProjectIndex].tools[
        this.state.selectedItemName
      ].hostedURL = this.state.currentAccount.projects[
        this.state.selectedProjectIndex
      ].tools[this.state.selectedItemName].hostedURL;
      tempArray.projects[this.state.selectedProjectIndex].tools[
        this.state.selectedItemName
      ].userName = this.state.currentAccount.projects[
        this.state.selectedProjectIndex
      ].tools[this.state.selectedItemName].userName;
      tempArray.projects[this.state.selectedProjectIndex].tools[
        this.state.selectedItemName
      ].password = this.state.currentAccount.projects[
        this.state.selectedProjectIndex
      ].tools[this.state.selectedItemName].password;
    }
  ...
  submitToolsData(toolsList) {
    ...
    axios
      .put(
        myConstClass.nodeAppUrl +
          `/accounts/` +
          this.state.dupeCurrentAccountArray._id,
        {
    ...
    return (
      <div>
        <SelectField
          ...
          value={
            this.state.dupeCurrentAccountArray.projects[
              this.state.selectedProjectIndex
            ].tools[this.state.selectedItemName].name
          }
          listStyle={{ backgroundColor: "#b7b7b7" }}
          menuItemStyle={{ color: "#000000 " }}
          labelStyle={{ color: "#000000 ", height: "35px" }}
          underlineStyle={{ display: "none" }}
        ...
        <div>
          <RaisedButton
            ...
            onClick={() =>
              this.submitToolsData(this.state.dupeCurrentAccountArray)
            }
            disabled={
              !this.state.dupeCurrentAccountArray.projects[
                this.state.selectedProjectIndex
...
class PeopleConfigurationDetails extends React.Component {
  constructor(props) {
    ...
    this.handleChangeInPeopleConfigInput = this.handleChangeInPeopleConfigInput.bind(
      this
    );
  ...
  componentWillReceiveProps(nextProps) {
    ...
    this.setState({
      tempObj: nextProps.selectedMemberObj,
      selectedPeopleIndex: nextProps.selectedMemberIndex
    });
  ...
  submitPeopleData(currentobj) {
    ...
    this.state.tempSelectedAccountobj.projects[
      this.state.currentProjectIndex
    ].people = this.state.tempSelectedAccountobj.projects[
      this.state.currentProjectIndex
    ].people.concat(currentobj);

    axios
      .put(
        myConstClass.nodeAppUrl +
          `/accounts/` +
          this.state.tempSelectedAccountobj._id,
        {
  ...
  updatePeopleData(updateObj) {
    this.state.tempSelectedAccountobj.projects[
      this.state.currentProjectIndex
    ].people[this.state.selectedPeopleIndex] = updateObj;
  ...
  deletePeopleData(slectedObj) {
    slectedObj.projects[this.state.currentProjectIndex].people.splice(
      this.state.selectedPeopleIndex,
      1
    );

    axios
      .put(myConstClass.nodeAppUrl + `/accounts/` + slectedObj._id, {
      ...
      <div>
        ...
        <div className="col-md-12 col-lg-12 padding0">
          ...
          <div className="col-md-12 displayInline textAlignLeft padding0">
            ...
            <div className="col-md-6 padding0">
              <input
                value={this.state.tempObj.emailid}
                name="emailid"
                onChange={this.handleChangeInPeopleConfigInput}
              />
            </div>
        ...
        <div className="col-md-12 col-lg-12 displayInline">
          <div className="col-md-4 col-lg-4">
            <RaisedButton
              ...
              primary={true}
              buttonStyle={buttonStyle}
              onClick={() => this.submitPeopleData(this.state.tempObj)}
            />
          </div>
          <div className="col-md-4 col-lg-4">
            <RaisedButton
              disabled={this.state.disableSubmit === false}
              label="Update"
              primary={true}
              buttonStyle={buttonStyle}
              onClick={() => this.updatePeopleData(this.state.tempObj)}
            />
          </div>
          <div className="col-md-4 col-lg-4">
            <RaisedButton
              ...
              buttonStyle={buttonStyle}
              onClick={() =>
                this.deletePeopleData(this.state.tempSelectedAccountobj)
              }
            />
          </div>
        </div>
