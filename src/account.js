...
class Account extends React.Component {
  constructor(props) {
    ...
    this.selectedBoardforSprintData = this.selectedBoardforSprintData.bind(
      this
    );
    ...
    this.ShowLoaderforTeamandQuality = this.ShowLoaderforTeamandQuality.bind(
      this
    );
  ...
  selectedAccount(event, ind, value, selecteAccount) {
    ...
    this.setState({
      accountName: value,
      projectDetails: selecteAccount[ind],
      value: value,
      projects: (
        <SelectedProjectDetails
          projectDetails={selecteAccount[ind]}
  ...
  render() {
    return (
      <div className="container-fluid padding0">
        <nav className="navbar navbar-fixed-top navbarBgColor navbarFontColor padding0">
          <div className="col-md-12 flex">
            <div className="col-md-3 col-lg-2 marginT16">
              ...
              <h4 className="margin0 pointer paddingL04">
            ...
            <div className="col-md-7 col-lg-8 textAlignCenter">
              ...
              <SelectField
                ...
                hintStyle={placeholderColor}
                labelStyle={{ color: "#fff", height: "40px" }}
                underlineStyle={{ display: "none" }}
                onChange={(e, i, v) =>
                  this.selectedAccount(e, i, v, this.state.accounts)
                }
              >
        ...
        >
          <div>
            ...
            <div className="loginUserName">
              <label>
                UserName:<input value="" name="userName" />
              </label>
            </div>
            <div className="loginPwd">
              <label>
                Password:<input value="" name="pswd" />
              </label>
            </div>
        ...
        <Modal
          isOpen={this.state.isAddProjectModal}
          style={customStyles}
          className={["col-sm-8 col-md-6  modalMargins overlay "].join(" ")}
        >
          <div>
            ...
            <div className="loginBtns">
              <div>
                <Button
                  ...
                  onClick={() =>
                    this.addProject(
                      this.state.projectDetails.account,
        ...
        <Modal
          isOpen={this.state.emptyAccountsObj}
          style={emptyObjectModalStyles}
        ...
        <Modal
          isOpen={this.state.emptyProjectsObj}
          style={emptyObjectModalStyles}
          className={["col-md-3 col-lg-3  modalMargins overlay "].join(" ")}
        >
          <div>
        ...
        <Modal
          isOpen={this.state.emptyToolsandPeopleObj}
          style={emptyObjectModalStyles}
          className={["col-md-3 col-lg-3  modalMargins overlay "].join(" ")}
        >
          <div>
...
class SelectedProjectDetails extends React.Component {
  ...
  selectProject(event, ind, value) {
    ...
    if (
      this.state.projectDetails.projects[ind].tools == undefined &&
      this.state.projectDetails.projects[ind].people == undefined
    ) {
      return this.props.errorMessage();
    }
    ...
    if (
      this.state.projectDetails.projects[ind].tools != undefined &&
      (this.state.projectDetails.projects[ind].people == undefined ||
        JSON.stringify(this.state.projectDetails.projects[ind].people) ==
          JSON.stringify([]))
    ) {
    ...
    return (
      <div>
        <SelectField
          ...
          labelStyle={{ color: "#fff", height: "40px" }}
          underlineStyle={{ display: "none" }}
          onChange={(e, i, v) => this.selectProject(e, i, v)}
        >
    ...
    axios
      .post(`sbtpgateway/tp/rest/esccors/generic/`, {
        resourceURL:
          ...
          this.state.projectBoardDetailsListarray[index].id +
          "/sprint",
